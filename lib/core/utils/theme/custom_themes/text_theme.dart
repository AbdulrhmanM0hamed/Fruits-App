...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 12.8, fontWeight: FontWeight.normal, color: Colors.black),
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 18.8, fontWeight: FontWeight.w600, color: Colors.black),
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w600, color: Colors.black),
    titleLarge: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w500, color: Colors.black),
    titleSmall: const TextStyle().copyWith(fontSize: 16.8, fontWeight: FontWeight.w400, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 12.8, fontWeight: FontWeight.normal, color: Colors.white),
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 18.8, fontWeight: FontWeight.w600, color: Colors.white),
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w600, color: Colors.white),
    titleLarge: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w500, color: Colors.white),
    titleSmall: const TextStyle().copyWith(fontSize: 16.8, fontWeight: FontWeight.w400, color: Colors.white),
